...
/**
 * Servlet implementation class FinanceAnalytics
 */
@WebServlet("/FinanceAnalytics")
public class FinanceAnalytics extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter out = response.getWriter()) {
			...
			try {
				jobject.put("sms", GetMessage.get_FinanceGraph());
				jarray.put(jobject);
				out.print(jarray);
