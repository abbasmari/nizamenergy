...
public class ServiceSoapProxy implements org.tempuri.ServiceSoap {
  ...
  public org.tempuri.ReceiveSMSResponseReceiveSMSResult receiveSMS(java.lang.String sAccessKey, java.lang.String sRequestId) throws java.rmi.RemoteException{
    if (serviceSoap == null)
      _initServiceSoapProxy();
    return serviceSoap.receiveSMS(sAccessKey, sRequestId);
  }
