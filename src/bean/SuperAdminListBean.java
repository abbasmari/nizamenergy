...
public class SuperAdminListBean {

	private int user_id;
	private String user_name;
	private String user_district;
	
	public SuperAdminListBean(){}
	
	public SuperAdminListBean(int user_id, String user_name,
	...
	public String toString() {
		return "SuperAdminListBean [user_id=" + user_id + ", user_name="
