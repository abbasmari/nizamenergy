...
<body>
							...
							<div class="table-responsive" style="font-size: 13px">
								<ul class="nav nav-pills f-s-15 inline bordered round-corner">
									<li>
										<div class="row">
											<div class="col-xs-4">
												<label for="ex1">From:</label> <input class="date-picker form-control"
													name="fromDate" id="fromDate">
											</div>

											<div class="col-xs-4">
												<label for="ex1">To:</label> <input class="date-picker form-control"
								...
								<table id="salesforce-fo-table" class="table table-bordered">
									<thead>
										<tr>
	...
	<script>
		function getTopFos() {
			...
			var table = $('#salesforce-fo-table').DataTable();
