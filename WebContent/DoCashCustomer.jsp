...
<body>
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="has-sub"><a href="doAlarmsPage.jsp"> <i
						...
						<li class="has-sub active"><a href="DoCashCustomer.jsp"> <i
					...
					.DataTable(
							{
								...
								"ajax" : {
									...
									"type" : "get",
									"data" : function(d) {
										d.action = "DOcash_customer", d.to = to,
												d.from = from
									},
										...
										$("#total_sale")
												.html(
														formatDollar(json.total_sale)
																+ "<b> PKR</b>");total_commission
										
										$("#total_net_income")
										.html(
												formatDollar(json.total_Amount-(json.nd_commission+json.fo_commission))
														+ "<b> PKR</b>");
										$("#total_fo_amount")
												.html(
	...
	<script>
		...
		/*  function dateChecker(){
		     $("#datepick").on("hover","#to, #from",function(){
		         $("#to").datepicker({maxDate: '+0d'  , changeMonth: true, changeYear: true });
		         $("#from").datepicker({maxDate: '+0d'});
		     });
		 }  */
	</script>
	...
	<script>
		...
		$(document).ready(function() {
			...
			/* $('#from, #to').change(PaymentFilterInit); */
