...
<body>
		...
		<div id="content" class="content">
			...
			<div class="col-md-12">
				...
				<div class="panel panel-inverse" data-sortable-id="morris-chart-4">
					<div class="panel-heading"
						...
						<h4 class="panel-title" style="font-size: 20px;">Finance
							Recovery Analytics Graph</h4>
					</div>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-inverse" data-sortable-id="morris-chart-4">
					<div class="panel-heading"
						style="background: #d9e0e7; color: black;">
						<h4 class="panel-title" style="font-size: 20px;">Sales
							Analytics Graph</h4>
					</div>
					<div class="panel-body" style="background: #d9e0e7">
						<!-- 							<h3>Salesmans Commission Graph</h3> -->
						<div id="chartdivSale" style="width: 100%; height: 400px;"></div>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-inverse" data-sortable-id="morris-chart-4">
					<div class="panel-heading"
						style="background: #d9e0e7; color: black;">
						<h4 class="panel-title" style="font-size: 20px;">Loan Book
							Analytics Graph</h4>
					</div>
					<div class="panel-body" style="background: #d9e0e7">
						<!-- 							<h3>Salesmans Commission Graph</h3> -->
						<div id="chartdivloan" style="width: 100%; height: 400px;"></div>
	...
	<script>
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							graph.title = "Recovered Recovery";
		...
		function salesmanBarChart_Loan() {
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							var graph = new AmCharts.AmGraph();
							graph.title = "Defaulter Customers";
							graph.labelText = "[[value]]";
							graph.valueField = "mobilink";
							graph.type = "column";
							graph.lineAlpha = 0;
							...
							// second graph
							graph = new AmCharts.AmGraph();
							graph.title = "Maintained Customers";
							graph.labelText = "[[value]]";
							graph.valueField = "telenor";
							graph.type = "column";
							graph.lineAlpha = 0;
